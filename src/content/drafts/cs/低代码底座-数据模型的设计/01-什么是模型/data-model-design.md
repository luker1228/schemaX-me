...
![](https://luke-1307356219.cos.ap-chongqing.myqcloud.com/articles/modelcraft_index_background.png)
...
我做了很多年数据模型设计。从入行到项目负责人，完整经历过一个数据模型产品的全生命周期。在我离开后，我实在code上瘾犯了，恰哈Vibecoding开始流行，所以又用 8 个月 Vibecoding 重写了一版。

分享这个项目的原因很简单：**它不像商城，购物车那种听着就很普遍的项目，这是一个很有意思的，单独领域项目的探索。**

这里我一个人完成了全栈的设计。

本着 **Teach is the best learning** 我想把这个项目分享给大家，然后写一个项目教程
...
![MySQL 选择是市场决策而非技术决策的推理框架](https://luke-1307356219.cos.ap-chongqing.myqcloud.com/articles/%E4%B8%BA%E4%BB%80%E4%B9%88%E6%98%AFMysql.png)
## 架构的核心思路
...
![设计态与运行态两阶段架构链路](https://luke-1307356219.cos.ap-chongqing.myqcloud.com/articles/%E9%93%BE%E8%B7%AF.png)
---
